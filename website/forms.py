...
class RegistrationForm(FlaskForm):
    ...
    def validate_username(self, username):
        ...
        if user:
            raise ValidationError('Username is taken, please choose another one and try again!')

    def validate_email(self, email):
        user = User.query.filter_by(email=email.data).first()
        if user:
            raise ValidationError('Email is taken, please choose another one and try again!')
